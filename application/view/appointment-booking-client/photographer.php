...
?>
<div class="photographer-container step-1 container-fluid mt-3 mb-3">
    <div class="row">
        <div class="col-md-4 mb-3">
            <div class="left-container p-3 bg-white">
                <div class="text-center">
                    <div class="hotel-logo-container mb-2">
                        <img class="img-fluid rounded-circle" src="<?= $imageFolder ?>photographer-appointment-logo.png" alt="Hotel Logo" style="width: 200px;">
                    </div>
                    <div class="hotel-text-container">
                        <span>Perfect Photography</span>
                        <h5>Appointment</h5>
                        <div class="clock-time my-2">
                            <i class="bi bi-clock-fill"></i> <span class="ms-2 duration">60 min</span>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="time-selection mt-5">
                                ...
                                <div class="selected-time-and-confirm d-flex mt-4">
                                    <div class="selected-time w-50 me-1 text-center">11:00</div>
                                    <button class="btn step-1-confirm-button w-50">Confirm</button>
                                </div>
                                <div class="time-slots mt-4">
                                    <div class="time-slot selected text-center">11:00</div>
                                    <div class="time-slot text-center">12:00</div>
                                    <div class="time-slot text-center">13:00</div>
                                    <div class="time-slot text-center">14:00</div>
                                    <div class="time-slot text-center">15:00</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="photographer-container step-2 container-fluid mt-3 mb-3 d-none">
    <div class="row">
        <div class="col-md-4 mb-3">
            <div class="left-container p-3 bg-white">
                <div class="text-center">
