...
<body>
    ...
    <!-- ======= Header ======= -->
    <!-- <header id="header" class="d-flex align-items-center d-none">
        <div class="container d-flex align-items-center justify-content-between">

             <h1 class="logo"><a href="#"><span><?php echo $brand ?></span></a>
            </h1> -->
    <!-- <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
                </ul>
                <a href="#" class="logo"><img src="<?= URL ?>file/builder-uploads/<?php echo $logoPath; ?>" alt="">
    ...
    <!-- ======= Hero Section ======= -->
    <section id="hero" class="bg-image" style="background-image: url('<?= URL ?>file/builder-uploads/<?php echo $bannerPath; ?>');">
        <nav id="navbar" class="navbar">
            <ul>
                <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
            </ul>
            <a href="#" class="logo mt-2">
                <img src="<?= URL ?>file/builder-uploads/<?php echo $logoPath; ?>" alt="" style="<?php echo $logoStyleString; ?>">
            </a>
            <ul>
                <li><a class="nav-link scrollto" href="#contact">Contact</a></li>
            </ul>
    ...
    <!-- End Hero -->
    <section class="paragraph-section" style="background-image: <?php echo $midSectionBg ?>;
                ...
                <div class="modal-content">
                    ...
                    <div class="page-body">
                        <div class="head">
                            ...
                            <h4>Contact form is submitted successfully</h4>
                        </div>
        ...
        <section id="contact" class="contact" style="background-image: <?php echo $bottomSectionBg ?>;
            ...
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    ...
                    <form class="mt-4" id="vendor-intro-form" action="<?= URL ?>submit-landing-page/submitVendorIntro" method="post" enctype="multipart/form-data">
                        ...
                        <button type="button" id="vendor-intro-submit-btn" class="btn btn-md btn-primary mt-3 vendor-submit-button">Submit</button>
                    </form>
                </div>
