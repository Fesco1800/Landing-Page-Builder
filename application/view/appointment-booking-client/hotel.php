...
?>
<div class="hotel-container step-1 container-fluid mt-3 mb-3">
    <div class="row">
        <div class="col-md-4 mb-3">
            <div class="left-container p-3 bg-white">
                <div class="text-center">
                    <div class="hotel-logo-container mb-2">
                        <img class="img-fluid rounded-circle" src="<?= $imageFolder ?>hotel-appointment-logo.png" alt="Hotel Logo" style="width: 200px;">
                    </div>
                    <div class="hotel-text-container">
                        <span>The Royal Hotel</span>
                        <h5>Appointment</h5>
...
<div class="hotel-container step-2 container-fluid mt-3 mb-3 d-none">
    <div class="row">
        <div class="col-md-4 mb-3">
            <div class="left-container p-3 bg-white">
                <div class="text-center">
